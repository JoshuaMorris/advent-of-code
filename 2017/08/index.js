...
const parse = (str) => {
    ...
    return [reg, getOperator(mod), parseInt(amnt), op1, getComp(cond), parseInt(op2)];
};
...
const soln = (input) => {
    ...
    return [Math.max.apply(null, Object.values(registers)), Math.max.apply(null, Object.values(runtime))];
};
...
console.assert(1 === soln(test)[0]);
console.assert(10 === soln(test)[1]);
